...
from django.contrib.auth.models import User # Gunakan User bawaan Django untuk otentikasi
from django.utils import timezone
from abc import ABC, abstractmethod

# --- MODEL YANG BERHUBUNGAN DENGAN USER ---
...
class Subscription(models.Model):
    ...
    class Meta:
        abstract = True # Ini adalah class abstrak
...
class ListeningHistory(models.Model):
    ...
    def add_event(self, song_object):
        # Misalnya, song_object memiliki atribut .title dan .artist_name
